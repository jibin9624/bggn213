...
The top three positions are absolutely invariant here. Let's use the ordering indices determined with the `order()` function above to find out more about the positions.
